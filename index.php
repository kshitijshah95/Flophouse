<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $active = $row['active'];
      $register= mysqli_fetch_array($result,'register');
        ...
        <div class="bg-filter sTop">
            <div class="container">
                <div class="jumbotron trn v-center">
                    ...
                    <div class="col-md-4">
                        <form role="form" name="loginform" method="POST" action="" onsubmit="return(regvalidate())">
                            <h2>Login</h2>
                            <div class="form-group ">
                              ...
                              <div style = "font-size:15px; font-weight:bolder; color:#cc0000; margin-top:10px"><?php echo $error; ?></div>
                              <div class="checkbox">
